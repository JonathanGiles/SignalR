...
class HubConnectionTest {
    ...
    public void checkHubConnectionState() throws Exception {
        ...
        HubConnection hubConnection = new HubConnection("http://example.com", mockTransport, true, Level.FINEST, new TestHttpClient());
        hubConnection.start();
    ...
    public void constructHubConnectionWithHttpConnectionOptions() throws Exception {
        Transport mockTransport = new MockTransport();
        HubConnection hubConnection = HubConnectionBuilder.create("http://www.example.com")
    ...
    public void completionMessageCanHaveError() throws Exception {
        ...
        assertEquals("java.lang.RuntimeException: There was an error", exceptionMessage);
    }
    ...
    public void negotiateSentOnStart() {
        ...
        HubConnection hubConnection = HubConnectionBuilder.create("http://example.com").withHttpClient(client).build();
